...
function populate() //Function to populate the input boxes from the customer listbox 
{
...
function toggleLock() //Function to disable or enable input boxes according to buttons that are clicked
{
...
{
	if(document.getElementById("custID").setValidity)
	{
...
function confirmCheck() //Function that gives the user a confirmation box to decide if the custoemr details to be amended are correct before the form gets submitted
{
var response;
