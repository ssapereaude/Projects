...
<html lang="en">
    ...
    <body>
        ...
        <div class="amendBox"> <!--Div class for the amend/view form -->
            ...
            <br>
			Choose a customer from the listbox to amend or view their details
				<br>
            ...
            <input type="submit" value="Save Changes" name="saveChangeID" onclick = confirmCheck() /><br><br> <!--Submit button input. Value sets the text within the button and runs the javascript function confirmDeletion upon clicking the submit button -->
			</div>
            </fieldset>
        </div>
    </form>
