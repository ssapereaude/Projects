...
function populateSearchListbox() //Function is the same as above but with the listbox that is generated by the customer search
{
...
function confirmDeletion() //Function that gives the user a confirmation box to decide if the details of the customer to be deleted are correct before the form gets submitted
{
    var confirmation
    ...
    else
    {
        ...
        document.getElementById("custID").disabled = true; //Setting this to false allows the information to be submitted to the confirmDeletion page
