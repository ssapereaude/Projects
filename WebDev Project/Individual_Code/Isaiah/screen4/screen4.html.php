...
?>
    ...
    <br>
    <div class="amendBox">
    <form action = "screen4.html.php" method = "POST" > <!--Submitting the form to the current page as trying to submit the details to another php file to be handled takes it to the corresponding page -->
    <div>
