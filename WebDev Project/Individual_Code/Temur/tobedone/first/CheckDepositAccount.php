...
<div class="subjectbox">
            ...
            <?php 
				...
				if ($CustomerID)	
				{
					...
					{
						echo "<h3>Such person already has a deposit account<br>Let's try again!</h3>";
					}

                    else
                    {
                        header('Location: SetupDepositAccount.php');	
                    }
				}

				else
				{
					echo "<h4>Unfortunately, you didn't select anyone. If you wish to continue, go back and select again.</h4>";	
				}

			?>
				<form action="OpenDepositAccount.php">		
					<button type="submit" class="myButton">Would you like to go back to the previous page ? Click here!</button>	
				</form>
		</div>
    </body>
</html>