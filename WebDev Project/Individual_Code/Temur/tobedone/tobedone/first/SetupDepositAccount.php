      ...
      <ul class="nav-list" style="list-style-type: none">
		...
		<div class="subjectbox">
			...
			include "bankConnect.inc.php";
				...
				$sql = "SELECT AccountID FROM account WHERE AccountID=(SELECT MAX(AccountID) FROM account)";	
				...
				$sql = "SELECT InterestRate FROM rate WHERE RateID=2";	
			...
			<p id="display">
				<form id="myForm" onsubmit="return confirmCheck()" onload="lock()" action="DepositAccountTransaction.php" method="POST">	
					<div class="inputbox">
