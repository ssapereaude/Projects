      ...
      <ul class="nav-list" style="list-style-type: none">
		...
		<h1>Deposit Account Transaction Page</h1>
            ...
            include "bankConnect.inc.php";
				...
				$Balance=$AmountReq * $interestRate;
				...
				else
				{
					...
					echo "<br>Interest Rate: " . $interestRate * 100 - 100 . " %";
					echo "<br>The today's date is: " . $TodayDate;

				}

				$sql = "SELECT TransactionID FROM transaction WHERE TransactionID=(SELECT MAX(TransactionID) FROM transaction)";	
        		...
        		$sql = "INSERT INTO transaction (TransactionID, AccountID, AccountType, Type, Amount, Date, Balance) VALUES ('$transactionID','$AccountID','Deposit','Deposit','$AmountReq','$TodayDate','$Balance')";	
			...
			?>
				<form action="OpenDepositAccount.php">
